...
## General decisions, tech stack
 - Project uses Java 21 (Gradle) + SpringBoot for backend and Vue as frontend framework based on personal preference.
...
## How to run project
Prerequisites: Docker Engine running, safe to also have Java 21 + Gradle preinstalled.
